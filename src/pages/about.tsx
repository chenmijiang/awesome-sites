    ...
    <>
      ...
      <AboutWrapper className="w-full">
        <div className="md:w-[750px] w-11/12 py-5 mx-auto box-border">
          <h1>关于本站</h1>
          <h2>
            <Icon icon="twemoji:palm-tree" width={24} height={24} /> 这是什么
          </h2>
          <p>
            收录前端各类技术站点。 包括但不限于前端技术站点、技术周刊、
            <b>高质量</b>
            个人博客、前端公众号、技术规范、开源项目站点等。
            仅限中文、英文，英文最好。
          </p>
          <h2>
            {" "}
            <Icon icon="twemoji:palm-tree" width={24} height={24} /> why
          </h2>
          <p>
          ...
          <p>
            2.
            尤其对于国外的个人博客，经常会忘记他们叫什么，想搜索都不知道搜什么。
          </p>
          <p>
            3. 想技术提升的时候，有个统一的地方，找到这个仓库就可以找到大部分
            <b>新鲜的</b>技术资讯。
          </p>
          ...
          <h2>
            {" "}
            <Icon icon="twemoji:palm-tree" width={24} height={24} /> 项目源地址
          </h2>
          <p>
